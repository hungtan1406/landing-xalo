...
const ResultPage = () => {
    ...
    return (
      <div className='min-h-screen flex flex-col items-center justify-center bg-white p-4'>
        <p className='text-xl text-gray-800 mb-4'>
          Không tìm thấy kết quả. Vui lòng làm lại quiz.
        </p>
  ...
  const {
    knowledgeScore: rawKnowledgeScore,
    skillsScore: rawSkillsScore,
      ...
      <Dialog open={isModalOpen} onOpenChange={setIsModalOpen}>
        <DialogContent className='sm:max-w-[425px]'>
          <DialogHeader>
            ...
            <DialogDescription>
              Vui lòng nhập Họ và Tên cùng Email để tải xuống kết quả chi tiết
              và nhận lộ trình học tập được cá nhân hóa.
            </DialogDescription>
          </DialogHeader>
